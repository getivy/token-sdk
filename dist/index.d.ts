...
export interface components {
    schemas: {
         ...
         * @enum {string}
         */
        CredentialFieldType: 'INVALID' | 'FIELD' | 'PASSWORD' | 'PSU_MESSAGE' | 'IMAGE' | 'FLICKER' | 'DECOUPLED' | 'CONFIRMATION';
        /** @description Specific information regarding the bank required by the respective Open Banking API standard adopted (CMA9, NextGenPSD2, PolishAPI, or STET). */
         ...
         * @enum {string}
         */
        Cma9PaymentContextCode: 'INVALID_PAYMENT_CONTEXT_CODE' | 'BILL_PAYMENT' | 'ECOMMERCE_GOODS' | 'ECOMMERCE_SERVICES' | 'OTHER' | 'PARTY_TO_PARTY';
         ...
         * @enum {string}
         */
        TokenRequestPayloadAccessBodyAccountResourceType: 'ACCOUNT_INVALID' | 'ACCOUNT_INFO' | 'ACCOUNT_BALANCE' | 'ACCOUNT_TRANSACTIONS' | 'ACCOUNT_TRANSFER_DESTINATIONS' | 'ACCOUNT_FUNDS_CONFIRMATION' | 'ACCOUNT_STANDING_ORDERS';
        /**
         ...
         * @enum {string}
         */
        TokenRequestPayloadAccessBodyResourceType: 'INVALID' | 'ACCOUNTS' | 'BALANCES' | 'TRANSACTIONS' | 'TRANSFER_DESTINATIONS' | 'STANDING_ORDERS';
         ...
         * @enum {string}
         */
        TransactionStatus: 'PROCESSING' | 'SUCCESS' | 'PENDING_EXTERNAL_AUTHORIZATION' | 'FAILURE_CANCELED' | 'FAILURE_INSUFFICIENT_FUNDS' | 'FAILURE_PERMISSION_DENIED' | 'FAILURE_EXPIRED' | 'FAILURE_DECLINED' | 'FAILURE_GENERIC' | 'SENT' | 'INITIATED' | 'SETTLEMENT_IN_PROGRESS' | 'SETTLEMENT_COMPLETED' | 'SETTLEMENT_INCOMPLETE';
        /**
         ...
         */
        TransferDestinationEuDomesticNonEuroInstant: components['schemas']['EUIbanAccount'] | components['schemas']['BbanAccount'] | components['schemas']['ClearingNumberAccount'];
        /**
         * euDomesticNonEuro
         ...
         */
        TransferDestinationEuDomesticNonEuro: components['schemas']['EUIbanAccount'] | components['schemas']['BbanAccount'] | components['schemas']['ClearingNumberAccount'];
        /** fasterPayments */
        TransferDestinationFasterPayments: Record<string, never> & components['schemas']['FasterPaymentsAccount'];
        /** plusgiro */
        ...
        /** sepaInstant */
        TransferDestinationSepaInstant: Record<string, never> & components['schemas']['SepaInstantAccount'];
        /**
         * token
         ...
         * @enum {string}
         */
        EventType: 'INVALID' | 'TRANSFER_STATUS_CHANGED' | 'BULK_TRANSFER_STATUS_CHANGED' | 'STANDING_ORDER_STATUS_CHANGED' | 'REFUND_STATUS_CHANGED' | 'PAYMENT_STATUS_CHANGED' | 'VRP_STATUS_CHANGED' | 'VRP_CONSENT_STATUS_CHANGED' | 'BANK_AIS_OUTAGE_STATUS_CHANGED' | 'BANK_SIP_OUTAGE_STATUS_CHANGED';
        /** @description Specifies the types of webhook currently configured. */
        Config: {
        ...
        EUDomesticNonEuroAccount: components['schemas']['EUIbanAccount'] | components['schemas']['BbanAccount'] | components['schemas']['ClearingNumberAccount'];
        /** EUDomesticNonEuroInstantAccount */
        EUDomesticNonEuroInstantAccount: components['schemas']['EUIbanAccount'] | components['schemas']['BbanAccount'] | components['schemas']['ClearingNumberAccount'];
        /** EUIbanAccount */
        EUIbanAccount: {
            /**
             * @description The International Bank Account Number, used when sending interbank transfers or wiring money from one bank to another, especially across international borders. It consists of a two-letter country code followed by two check digits and up to thirty-five alphanumeric characters.
         ...
         * @enum {string}
         */
        RefundStatus: 'INITIATION_PENDING' | 'INITIATION_PROCESSING' | 'INITIATION_COMPLETED' | 'INITIATION_REJECTED' | 'INITIATION_FAILED';
         ...
         * @enum {string}
         */
        VrpStatus: 'INITIATION_PENDING' | 'INITIATION_PROCESSING' | 'INITIATION_COMPLETED' | 'INITIATION_REJECTED' | 'INITIATION_REJECTED_INSUFFICIENT_FUND' | 'INITIATION_FAILED' | 'INITIATION_NO_FINAL_STATUS_AVAILABLE';
        VrpConsentResponse: {
        ...
        DebtorInformation: (components['schemas']['SepaAccount'] | components['schemas']['SepaInstantAccount'] | components['schemas']['FasterPaymentsAccount'] | components['schemas']['ElixirAccount'] | components['schemas']['EUDomesticNonEuroAccount'] | components['schemas']['EUDomesticNonEuroInstantAccount'] | components['schemas']['BankGiroAccount'] | components['schemas']['PlusGiroAccount']) & {
            /**
        ...
        CreditorInformation: (components['schemas']['SepaAccount'] | components['schemas']['SepaInstantAccount'] | components['schemas']['FasterPaymentsAccount'] | components['schemas']['ElixirAccount'] | components['schemas']['EUDomesticNonEuroAccount'] | components['schemas']['EUDomesticNonEuroInstantAccount'] | components['schemas']['BankGiroAccount'] | components['schemas']['PlusGiroAccount']) & Record<string, never> & {
            /**
         ...
         * @enum {string}
         */
        PaymentStatus: 'INITIATION_PENDING' | 'INITIATION_PENDING_MORE_INFO' | 'INITIATION_PENDING_REDIRECT_AUTH' | 'INITIATION_PENDING_REDIRECT_AUTH_VERIFICATION' | 'INITIATION_PENDING_EMBEDDED_AUTH' | 'INITIATION_PENDING_EMBEDDED_AUTH_VERIFICATION' | 'INITIATION_PENDING_DECOUPLED_AUTH' | 'INITIATION_PENDING_REDEMPTION' | 'INITIATION_PENDING_REDEMPTION_VERIFICATION' | 'INITIATION_PROCESSING' | 'INITIATION_COMPLETED' | 'INITIATION_REJECTED' | 'INITIATION_REJECTED_INSUFFICIENT_FUNDS' | 'INITIATION_FAILED' | 'INITIATION_EXPIRED' | 'INITIATION_DECLINED' | 'CANCELED' | 'INITIATION_NO_FINAL_STATUS_AVAILABLE' | 'SETTLEMENT_IN_PROGRESS' | 'SETTLEMENT_COMPLETED' | 'SETTLEMENT_INCOMPLETE';
        /**
        ...
        Risk: {
             ...
             * @enum {string}
             */
            paymentContextCode?: 'BILL_PAYMENT' | 'ECOMMERCE_GOODS' | 'ECOMMERCE_SERVICES' | 'PARTY_TO_PARTY' | 'PISP_PAYEE' | 'OTHER';
            /**
        ...
        RefundAccount: (components['schemas']['IbanAccount'] | components['schemas']['UKDomesticAccount'] | components['schemas']['PLDomesticAccount'] | components['schemas']['BankgiroAccount'] | components['schemas']['PlusgiroAccount'] | components['schemas']['SepaAccount'] | components['schemas']['FasterPaymentsAccount']) & {
            /**
    ...
    'GatewayService.GetTransfers': {
        ...
        parameters: {
            ...
            query: {
                ...
                'filter.startTimeMs'?: string;
                'filter.endTimeMs'?: string;
                'filter.transactionStatus'?: 'PROCESSING' | 'SUCCESS' | 'PENDING_EXTERNAL_AUTHORIZATION' | 'FAILURE_CANCELED' | 'FAILURE_INSUFFICIENT_FUNDS' | 'FAILURE_PERMISSION_DENIED' | 'FAILURE_EXPIRED' | 'FAILURE_DECLINED' | 'FAILURE_GENERIC' | 'SENT' | 'INITIATED' | 'SETTLEMENT_IN_PROGRESS' | 'SETTLEMENT_COMPLETED' | 'SETTLEMENT_INCOMPLETE';
